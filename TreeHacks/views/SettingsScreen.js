...
export default function SettingsScreen(props) {
  ...
  const WeekView = () => {
      return <View>
        ...
        <Center h="20" w="10" bg="#9cdc98" rounded="md" shadow={2}>Mon</Center>
        <Center h="20" w="10" bg="#f7b1b1" rounded="md" shadow={2}>Tue</Center>
        <Center h="20" w="10" bg="#9cdc98" rounded="md" shadow={2}>Wed</Center>
        <Center h="20" w="10" bg="#9cdc98" rounded="md" shadow={2}>Thu</Center>
        <Center h="20" w="10" bg="#9cdc98" rounded="md" shadow={2}>Fri</Center>
        <Center h="20" w="10" bg="#f7b1b1" rounded="md" shadow={2}>Sat</Center>
